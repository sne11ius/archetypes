  ...
  private def mkFileDescriptor(archetype: Archetype, baseDir: File, filename: String)(implicit request: RequestHeader): FileDescriptor = {
    ...
    val descriptor = 
      if (0 == file.length()) {
        ...
        val textTypes = List("xml", "x-javascript", "sql", "jsf", "prefs", "factorypath", "mf", "gitignore", "license", "bnd", "as", "sh", "tfl", "cfg", "editorconfig", "page", "bat", "gitkeep", "hgignore", "sass", "scss", "yml", "json", "mustache", "gradlew", "proto", "pro", "desktop", "rb", "readme", "xhtml", "zul", "wpd", "xtend")
